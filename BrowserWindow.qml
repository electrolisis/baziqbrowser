            ...
            ToolButton {
                ...
                Menu {
                    ...
                    MenuItem {
                        id: checktor
                        text: "Check Tor"
                        onClicked: tabBar.createTab(currentWebView.profile, true, "https://check.torproject.org/");
                    }
                    MenuItem {
                        id: qtversion
                        text: "Qt Version"
                        onClicked: tabBar.createTab(currentWebView.profile, true, "chrome:qt");
                    }
                    // MenuItem {
                    //     id: errorPageEnabled
                    //     text: "ErrorPage On"
    ...
    Component {
        ...
        TabButton {
            ...
            contentItem: Rectangle {
                ...
                implicitHeight: Math.max(text.height + 5, 20)
                ...
                //Rectangle { x: parent.width - 2; height: parent.height ; width: 1}
                Text {
                    id: text
                    anchors.left: parent.left
